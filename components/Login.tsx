                ...
                <div className="flex items-center rounded-b-lg lg:w-6/12 lg:rounded-r-lg lg:rounded-bl-none bg-gradient-to-r from-[#11A37F] to-[#0A614C]">
                  <div className="px-4 py-6 text-white md:mx-6 md:p-12">
                    ...
                    <p className="text-sm">
                      ...
                      capable of understanding natural language queries, and can
                      answer questions, provide information, and help with
                      tasks. It can be used to generate story ideas and
                      conversations, making it perfect for creative writing and
                      brainstorming.
                    </p>
                  </div>
                </div>
